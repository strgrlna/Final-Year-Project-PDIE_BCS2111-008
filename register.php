...
<head>
   ...
   <title>Register Account | KPMB Printing Service</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="id" maxlength="100" required placeholder="enter your id" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
